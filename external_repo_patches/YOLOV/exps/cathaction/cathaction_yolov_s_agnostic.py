...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = os.path.abspath("datasets/collision_detection_yolov_agnostic")
        self.train_ann = "cathaction_train.json"
        self.val_name = "valid_combined"
        self.val_ann = "cathaction_valid_combined.json"
        self.output_dir = os.path.abspath("outputs/task2/yolov")
    ...
    def get_model(self):
        ...
        # Keep the pretrained detector trainable enough for domain adaptation.
